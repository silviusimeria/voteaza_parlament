...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference("Party.count") do
      post parties_url, params: { party: { color: @party.color, logo_url: @party.logo_url, name: @party.name } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { color: @party.color, logo_url: @party.logo_url, name: @party.name } }
